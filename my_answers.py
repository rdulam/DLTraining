...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error #[Source: Udacity forum]
        ...
        delta_weights_i_h += hidden_error_term * X[:, None] #[Source: Udacity forum]
        # Weight step (hidden to output)
        #delta_weights_h_o += self.lr * output_error_term * hidden_outputs[:, None]
        delta_weights_h_o += output_error_term * hidden_outputs[:, None] #[Source: Udacity forum]
...
##########################################################
iterations = 5600 #[Source: Udacity forum]
learning_rate = 0.5
hidden_nodes = 25
output_nodes = 1
